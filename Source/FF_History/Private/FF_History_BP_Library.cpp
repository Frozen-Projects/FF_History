...
bool UFF_History_BP_Library::GetVariableByName(FVariableContainer& Out_Container, UObject* In_Parent, FName In_Name)
{
...
bool UFF_History_BP_Library::GetAllVariables(FVariablePool& Out_Containers, UObject* In_Parent, bool bIncludeEditor, bool bIncludeNative, bool bIncludeRoot)
{
    if (!IsValid(In_Parent))
    {
        return false;
...
bool UFF_History_BP_Library::SetVariable(UObject* TargetParent, FName TargetVariable, FString NewData)
{
...
void UFF_History_BP_Library::SaveGameToFile(FDelegateSaveToFile DelegateSave, USaveGame* Instance_Save, FString In_Path)
{
...
void UFF_History_BP_Library::SaveGameToMemory(FDelegateSaveToMemory DelegateSave, USaveGame* Instance_Save)
{
    if (!IsValid(Instance_Save))
    {
...
void UFF_History_BP_Library::LoadGameFromFile(FDelegateLoadSave DelegateLoad, FString In_Path, TSubclassOf<USaveGame> SaveGameClass)
{
...
void UFF_History_BP_Library::LoadGameFromMemory(FDelegateLoadSave DelegateLoad, TArray<uint8> In_Buffer, TSubclassOf<USaveGame> SaveGameClass)
{
